...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info' , 'El rol se ha creado satisfactoriamente');
    }
    ...
    public function destroy(Role $role)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info', 'El rol ha sido eliminado éxitosamente');
    }
}